...
* 인증서에 가 있어야 합니다 `_subjectAltName_` StorageGRID의 DNS 항목과 일치합니다. 자세한 내용은 의 4.2.1.6절 "주체 대체 이름"을 참조하십시오 https://tools.ietf.org/html/rfc5280#section-4.2.1.6["RFC 5280: PKIX 인증서 및 CRL 프로필"^].

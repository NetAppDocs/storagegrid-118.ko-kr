...
NOTE: 이 지침은 소프트웨어 기반 스토리지 노드에만 적용됩니다. 을 참조하십시오 https://docs.netapp.com/us-en/storagegrid-appliances/sg6000/adding-expansion-shelf-to-deployed-sg6060.html["구축된 SG6060에 확장 쉘프를 추가합니다"^] 확장 쉘프를 설치하여 스토리지 볼륨을 SG6060에 추가하는 방법을 알아보십시오. 다른 어플라이언스 스토리지 노드를 확장할 수 없습니다.

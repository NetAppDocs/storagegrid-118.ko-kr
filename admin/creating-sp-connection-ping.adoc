...
* PingFederate 서버용 https://docs.pingidentity.com/pingfederate/latest/administrators_reference_guide/pf_administrators_reference_guide.html["관리자 참조 안내서"^]이(가) 있습니다. PingFederate 설명서에서 자세한 단계별 지침과 설명을 확인할 수 있습니다.
